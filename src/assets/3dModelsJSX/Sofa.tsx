...
Command: npx gltfjsx@6.2.3 public/sofa/sofa_03_4k.gltf -t -r public
*/
...
export function Sofa(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/sofa/sofa_03_4k.gltf') as GLTFResult
  return (
...
useGLTF.preload('/sofa/sofa_03_4k.gltf')
